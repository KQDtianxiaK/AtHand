...
const KIMI_MODES: AgentProviderModeDefinition[] = [
  ...
  },
  {
    id: "plan",
    label: "Plan",
    description: "Ask Kimi Code to inspect and plan without direct implementation bias",
    icon: "ShieldCheck",
    colorTier: "planning",
  },
  {
    id: "continue",
    label: "Continue",
    description: "Continue the current working context without an explicit persisted session handle",
    icon: "ShieldAlert",
    colorTier: "moderate",
  },
];
...
export const AGENT_PROVIDER_DEFINITIONS: AgentProviderDefinition[] = [
  ...
  },
  {
    id: "kimi",
    label: "Kimi Code",
    description: "Moonshot's Kimi Code CLI with stream-json output and session resume support",
    defaultModeId: "default",
    modes: KIMI_MODES,
  },
  {
